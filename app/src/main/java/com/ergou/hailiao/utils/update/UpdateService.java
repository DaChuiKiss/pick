package com.ergou.hailiao.utils.update;
...
//                        .setAutoCancel(true)
//                        .setContentTitle(apkName)
//                        .setContentText(getResources().getText(R.string.prompt58))
//                        .setTicker(getResources().getText(R.string.prompt59))
//                        .setContentIntent(updatePendingIntent)
//                        .setSmallIcon(R.mipmap.magic)
//                        .setWhen(System.currentTimeMillis())
//                        .setOngoing(true);
...
//                    builder = new Notification.Builder(UpdateService.this)
//                            .setAutoCancel(true)
//                            .setContentTitle(getResources().getText(R.string.prompt59))
//                            .setContentText((int)totalSize*100/updateTotalSize+"%")
//                            .setTicker(getResources().getText(R.string.prompt60))
//                            .setContentIntent(updatePendingIntent)
//                            .setSmallIcon(R.mipmap.magic)
//                            .setWhen(System.currentTimeMillis())
//                            .setOngoing(true);
