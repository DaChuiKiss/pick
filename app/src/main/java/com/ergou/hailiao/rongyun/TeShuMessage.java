 ...
 */
@MessageTag(value = "award", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
public class TeShuMessage extends MessageContent {
    //自定义的属性
     ...
     */
    public static final Creator<TeShuMessage> CREATOR = new Creator<TeShuMessage>() {

        @Override
        public TeShuMessage createFromParcel(Parcel source) {
            return new TeShuMessage(source);
        }

        @Override
        public TeShuMessage[] newArray(int size) {
            return new TeShuMessage[size];
        }
    };
