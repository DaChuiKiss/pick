...
public class SealExtensionModule extends DefaultExtensionModule {
    ...
    public List<IPluginModule> getPluginModules(Conversation.ConversationType conversationType) {
        if (conversationType.equals(Conversation.ConversationType.PUBLIC_SERVICE)) {
            ...
            IPluginModule locationPlugin1 = new LocationPlugin();
//            IPluginModule dasdas =  new RealTimeLocationPlugin();
//            IPluginModule das =  new CombineLocationPlugin();
//            IPluginModule das =  new ZhuanZhang();
            pluginModuleList.add(image);
            pluginModuleList.add(locationPlugin);
            pluginModuleList.add(locationPlugin1);
//            pluginModuleList.add(dasdas);
//            pluginModuleList.add(das);
            try {
