 ...
 */
public class SealExtensionOneModule extends DefaultExtensionModule {

    public SealExtensionOneModule(Context context) {
        super(context);
    }
...
//        IPluginModule redEnvelopes = new RedEnvelopes();
        ...
        pluginModuleList.add(transferAccounts);//转账
