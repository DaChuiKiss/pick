...
public class RedEnvelopeGrabPerson extends RxPresenter<RedEnvelopeGrabContract.MainView>
        implements RedEnvelopeGrabContract.Presenter {
    private RetrofitUtil mRetrofitHelper;
    private Activity activity;

    @Inject
    public RedEnvelopeGrabPerson(RetrofitUtil mRetrofitHelper, Activity activity) {
