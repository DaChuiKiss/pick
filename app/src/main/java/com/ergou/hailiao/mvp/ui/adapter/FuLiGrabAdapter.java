 ...
 */
public class FuLiGrabAdapter extends ItemViewProvider<RedEnvelopeGrabBean.AllRobBean,
        FuLiGrabAdapter.MyViewHolder> implements View.OnClickListener {
    ...
    protected MyViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        MyViewHolder holder = new MyViewHolder(inflater.inflate(R.layout.item_fuli_grab, parent, false));
        return holder;
    }
