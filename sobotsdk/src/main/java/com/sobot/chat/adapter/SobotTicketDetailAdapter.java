...
public class SobotTicketDetailAdapter extends SobotBaseAdapter<Object> {
    ...
    class Type2ViewHolder extends BaseViewHolder {
        ...
        private View sobot_tv_content_split;
        ...
        Type2ViewHolder(Context context, View view) {
            ...
            sobot_tv_content_split = (View) view.findViewById(ResourceUtils.getResId(context, "sobot_tv_content_split"));
                ...
                if (reply.getStartType() == 0) {
                    ...
                    if (TextUtils.isEmpty(reply.getReplyContent())) {
                        ...
                        if (StringUtils.getImgSrc(reply.getReplyContent()).size() > 0) {
                            ...
                            sobot_tv_content_split.setVisibility(View.VISIBLE);
                            sobot_tv_content.setPadding(36,30,36,30);
                            sobot_tv_content_detail.setPadding(36,30,36,30);
                    ...
                    sobot_tv_content.setText(TextUtils.isEmpty(reply.getReplyContent()) ? "无" : Html.fromHtml(reply.getReplyContent().replaceAll("<img.*?/>", " [图片] ")));
                }
